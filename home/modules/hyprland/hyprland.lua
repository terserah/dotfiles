...
-- shraescreen
-- hl.bind(mainMod .. " + O", hl.dsp.exec_cmd("~/.config/hypr/scripts/monitor.sh")) -- versi arch
hl.bind(mainMod .. " + o", hl.dsp.exec_cmd("~/.local/bin/present-mode"))
